import {
  ...
  getFollowers,
  getFollowings,
} from "@/access-data/followers";
import { getUserPosts } from "@/access-data/posts";
import { fetchCurrentUser, getUserById } from "@/access-data/users";
  ...
  return (
    <div className="bg-neutral-900 p-3 m-2 rounded-lg w-full">
      ...
      {currentUser?.id !== user.id && (
        <FollowButton user={user} currentUser={currentUser} isFollow={follow} />
      )}
      <div className="mt-2">
        {posts?.length === 0 ? (
